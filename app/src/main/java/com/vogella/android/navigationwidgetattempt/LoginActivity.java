...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                LoginActivity.driver.email = DUMMY_DRIVER.email;
                LoginActivity.driver.username = DUMMY_DRIVER.username;
                LoginActivity.driver.phone = DUMMY_DRIVER.phone;
                LoginActivity.driver.gender = DUMMY_DRIVER.gender;
                finish();
            } else {
